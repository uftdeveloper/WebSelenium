...
public class AppiumAndroidKeywords {
private static boolean dataWrite(FinalTestScriptObject ftso, AppiumAndroidObject wo, String result) throws IOException, Throwable{
	...
	public static FinalTestScriptObject switchToKeywords(FinalTestScriptObject ftso, AppiumAndroidObject wo) throws IOException, Throwable{
				...
				case ParamsObject.KW_CONSTANT_CLOSE_POP_UP_WINDOW :
			        ...
			        for(String popupHandle : pops){
			            if(!popupHandle.contains(parent))
			            {
				            ...
				            //System.out.println("Popu Up Title: "+ wo.getWd().switchTo().window(popupHandle).getTitle());
				            wo.getWd().close();
			            }
			        }
